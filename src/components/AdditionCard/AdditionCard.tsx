...
export const AdditionCard: React.FC<Props> = ({additionalInfo, isLoading}) => {
    ...
    <div className={styles.container}>
      {isLoading ? <Loader /> : (
          <div className={styles.card}>
            ...
            </div><div className={styles.carousel}>
              {images && (isCarousePartVisible ? (
                images.map((image: any) => <img
                ...
                images.slice(0, 3).map((image: any, index) => <div className={styles.hidden_images} style={{}} key={image.id}>
                  <img
                    className={styles.img}
                    src={image.src}
                    alt={image.alt} />
